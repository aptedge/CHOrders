...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If ConfigurationManager.AppSettings("RX") = "yes" Then
            item_list.Columns(2).Visible = True
        End If
    ...
    Sub LoadView()
        Try
            ...
            dt.Columns.Add("CustomerDEA", GetType(String))
            ...
            Dim lstCust As List(Of Customer) = tpsData.GetActiveCustomers()

            For Each c As Customer In lstCust
                Dim sCustNo As String = Right("000000" + c.CustomerNo, 6)

                If c.CustomerNo > "" Then
                    dt.Rows.Add(c.CustomerNo, sCustNo, c.DEANo, c.CustomerName, c.Address, c.City, c.State, c.Phone)
                End If
            Next
